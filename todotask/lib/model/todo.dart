...
class ToDo {
  ...
  static List<ToDo> todoList() {
    ...
    return [
      ToDo(
        id: '1',
        todoText: 'Submit assignment',
      ), // A completed task
      ToDo(
          id: '2',
          todoText: 'Go to the mosque',
          isDone: true), // A completed task
      ToDo(id: '3', todoText: 'Visit the sick'), // A completed task
      ToDo(id: '4', todoText: 'Have lunch'), // An incomplete task
      ToDo(id: '5', todoText: 'Sleep '), // An incomplete task
      ToDo(id: '6', todoText: 'Booka ticket'), // An incomplete task
    ];
  }
}
